...
class MainVC: UIViewController, AVCaptureMetadataOutputObjectsDelegate, CLLocationManagerDelegate {
...
//        InitCurrentCityLoaction()
    ...
    @IBAction func GotoWeatherInformation(_ sender: Any) {
        ...
        {
            let WeatherView:CurrentWeatherConditionController = CurrentWeatherConditionController()
